...
const songs = [
    {
        ...
        poster : "/Albums/Artists/BTS/images/8.jpg",
    },
    {   
        id: 2,
        songName: `Boy in Luv<br><div class="subtitle">BTS</div>`,
        poster : "/Albums/Artists/BTS/images/8.jpg",
    },
    {
        id: 3,
        songName: `Burning Up<br><div class="subtitle">BTS</div>`,
        poster :"/Albums/Artists/BTS/images/8.jpg",
    },
    {
        id: 4,
    ...
    {
        id: 6,
        songName: `Jamais Vu<br><div class="subtitle">BTS</div>`,
        poster : "/Albums/Artists/BTS/images/8.jpg",
    },
    {
        id: 7,
        songName: `Run<br><div class="subtitle">BTS</div>`,
        poster : "/Albums/Artists/BTS/images/8.jpg",
    },
    {
        id: 8,
        songName: `Trivia - Seesaw<br><div class="subtitle">BTS</div>`,
        poster : "/Albums/Artists/BTS/images/8.jpg",
    },
]
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click', (els)=>{
        index = els.target.id;
        // console.log(index);
        music.src = `/Albums/Artists/BTS/audio/${index}.mp3`;
        music.play();
        poster_master_play.src = `/Albums/Artists/BTS/images/${index}.jpg`;
        ...
        // Download music 
        download_music.href = `/Albums/Artists/BTS/audio/${index}.mp3`;
